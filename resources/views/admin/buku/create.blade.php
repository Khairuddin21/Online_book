...
<div class="content-header">
    <div>
        <h2 style="margin: 0; font-size: 22px; font-weight: 700; color: var(--text-dark);">Tambah Buku Baru</h2>
        <p style="margin: 4px 0 0; color: var(--text-muted); font-size: 14px;">Isi formulir untuk menambahkan buku baru</p>
    </div>
    ...
    <div style="display: grid; grid-template-columns: 1.2fr 1fr; gap: 24px; align-items: start;">
        ...
        <div class="form-card">
            ...
            <div class="form-group">
                ...
                <input type="text" name="judul" value="{{ old('judul') }}" required class="form-input {{ $errors->has('judul') ? 'is-invalid' : '' }}" placeholder="Masukkan judul buku">
            ...
            <div class="form-group">
                ...
                <input type="text" name="isbn" value="{{ old('isbn') }}" required class="form-input {{ $errors->has('isbn') ? 'is-invalid' : '' }}" placeholder="Contoh: 978-602-XXX-XXX-X">
            ...
            <div class="form-group">
                ...
                <input type="text" name="penulis" value="{{ old('penulis') }}" required class="form-input {{ $errors->has('penulis') ? 'is-invalid' : '' }}" placeholder="Nama penulis buku">
            ...
            <div class="form-group">
                ...
                <input type="text" name="penerbit" value="{{ old('penerbit') }}" required class="form-input {{ $errors->has('penerbit') ? 'is-invalid' : '' }}" placeholder="Nama penerbit buku">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                <div class="form-group">
                    ...
                    <input type="number" name="tahun_terbit" value="{{ old('tahun_terbit') }}" required class="form-input" min="1900" max="{{ date('Y') + 1 }}" placeholder="{{ date('Y') }}">
        ...
        <div>
            <div class="form-card" style="margin-bottom: 20px;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                    <div class="form-group">
                        ...
                        <input type="number" name="harga" value="{{ old('harga') }}" required class="form-input" min="0" step="1000" placeholder="0">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="stok" value="{{ old('stok') }}" required class="form-input" min="0" placeholder="0">
                ...
                <div class="form-group">
                    ...
                    <input type="url" name="cover" value="{{ old('cover') }}" class="form-input {{ $errors->has('cover') ? 'is-invalid' : '' }}" placeholder="https://example.com/cover.jpg">
                ...
                <div class="form-group" style="margin-bottom: 0;">
                    ...
                    <textarea name="deskripsi" class="form-input" rows="5" placeholder="Sinopsis atau deskripsi buku...">{{ old('deskripsi') }}</textarea>
            ...
            <div class="info-card">
                ...
                <ul>
                    <li>Gunakan ISBN yang valid dan unik</li>
                    <li>Cover URL harus berupa link gambar yang valid</li>
                    <li>Deskripsi membantu pembeli memilih buku</li>
                </ul>
            </div>
        </div>
    </div>
